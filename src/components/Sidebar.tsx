...
import { Problem, QuestionStatus } from "../types";
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div className="bg-gray-50 transition-all duration-300 w-80 fixed left-0 top-[96px] h-[calc(100vh-100px)] z-10 overflow-y-auto">
      <div className="mx-4 pt-[30px] pb-4 border-b-2 border-gray-300 flex items-center justify-between">
        <button className="flex space-x-2 items-center px-3 py-2 bg-transparent text-gray-500 rounded-md text-sm font-medium cursor-auto">
          <svg
            width="16"
            height="12"
            viewBox="0 0 18 15"
        ...
        <button
          ...
          className="py-2 text-gray-400 transition-colors"
        >
          <X size={20} />
        </button>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <span className="font-medium text-sm">Problem {index + 1}</span>
